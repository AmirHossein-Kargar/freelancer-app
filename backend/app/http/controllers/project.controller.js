...
class ProjectController extends Controller {
  async addNewProject(req, res) {
    ...
    if (!project?._id)
      throw createHttpError.InternalServerError("Project creation failed");
  ...
  async changeProjectStatus(req, res) {
    ...
    if (updateResult.modifiedCount === 0)
      throw createHttpError.InternalServerError("Project status update failed");
  ...
  async deleteProject(req, res) {
    ...
    if (project.freelancer)
      throw createHttpError.BadRequest("This project cannot be deleted");
  ...
  async updateProject(req, res) {
    ...
    if (updateResult.modifiedCount == 0)
      throw createError.InternalServerError("Project update failed");
    return res.status(HttpStatus.OK).json({
      statusCode: HttpStatus.OK,
      data: {
